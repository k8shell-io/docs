...
- **User management** — find, onboard, and update users via the [Identity service](/architecture/identity).
- **Workspace operations** — list, create, start, stop, and delete workspaces via the [Provisioner](/architecture/provisioner).
- **Session access** — retrieve current and past sessions from the [Session service](/architecture/session).
