...
For details on the provisioning mechanics see the [Standalone Pod](/architecture/provisioner/standalone-pod) and [Workload injection](/architecture/provisioner/workload-injection).
