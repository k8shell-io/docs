...
For more details, see [Credential Helpers](/architecture/workspace/access#credential-helpers)
...
For more details, see [Agent Forwarding](/architecture/ssh-proxy/communication-flows#agent-forwarding).
...
For more details see [IP Address Protection](../ssh-proxy/ip-protection.md) and [SSH Shield](/architecture/ssh-shield).
