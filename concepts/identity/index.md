...
* **JWT Issuance.** Identity acts as a [JWT issuer](./jwt-issuer.md) and mints tokens for authenticated user identities. The API Server uses these tokens to authorize API requests originating from external clients and from workspaces.
